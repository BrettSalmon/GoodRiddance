...
#                    else:
#                        price = (str(soup.find('span', class_="_1pfzjcs")).split(">")[1].split("</span")[0])                        
#                else:
#                    if (soup.find('span', class_="_ckr320"))==None:
#                        price = (str(soup.find('span', class_="_1pfzjcs")).split(">")[1].split("</span")[0])
#                    else:
#                        price = (str(soup.find('span', class_="_ckr320")).split(">")[1].split("</span")[0])
#
...
#
modified_df = pd.read_csv(thedir+city+'/fiducial_'+item+'.csv', index_col=0)
...
print('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
cs.run(item, city, thedir, 'offerup',first=True, features_only=True)
